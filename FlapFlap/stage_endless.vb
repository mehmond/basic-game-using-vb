Public Class stage_endless
    ...
    Private Sub stage_endless_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LoadtoGrid("SELECT playerName,score FROM tblplayer WHERE `playerName` = '" & pname & "'", DTGKO)
        lb_pname.Text = pname
        DTGKO.Enabled = False
        Randomize()
        CreatePipes(1)
    ...
    Private Sub stage_endless_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        For i = 0 To 1
            ...
            If imageCollide(pipe(i), pb_bird) = True Or imageCollide(tPipe(i), pb_bird) Or
                ...
                SQLquery("UPDATE `tblplayer` SET `score` = '" & score & "' WHERE `pname` = '" & pname & "'")
                Timer1.Stop()
                Timer2.Start()
            End If
